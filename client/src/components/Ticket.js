...
import { useNavigate } from 'react-router-dom';
import { Modal, Button } from 'react-bootstrap';
import { FaPlaneDeparture, FaPlaneArrival, FaChair, FaTicketAlt } from 'react-icons/fa'; // Icons
            ...
            <div className="single-ticket">
              ...
              <div className="ticket-row">
                <div className="ticket-section">
                  ...
                  <p className="important-detail"><strong>{bookedData.commercialFlightId.flight.flightNo}</strong></p>
                </div>
                <div className="ticket-section">
                  <h3>Gate</h3>
                  <p>{bookedData.gateNumber || 'TBD'}</p>
