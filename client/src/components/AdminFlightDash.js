...
//         if (!flightsRes.ok || !airplanesRes.ok || !routesRes.ok || !pricingRes.ok) {
...
//       notyf.error('No flights generated. Please check your date range and flight day.');
//       return;
//     }
...
//                 ))
//               ) : (
//                 <option disabled>No pricings available</option>
//               )}
//             </select>
//           </div>
//         </Modal.Body>
